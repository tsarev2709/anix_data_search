...
9. В обычном цикле кандидат сохраняется в закрытой очереди. После одобрения панель запускает `sync-approved`, и контакт связывается со сделкой или становится основой новой сделки. В примечание попадают балл и URL источников.
